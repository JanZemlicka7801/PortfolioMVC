...
{
    // Configured the password to be 12 characters and needs to contain digits as below
    ...
    try
    {
        ...
        if (adminUser == null)
        {
            var admin = new AppUser
            {
                ...
                Department = PortfolioMVC.Models.Enums.Department.It,
                EmailConfirmed = true
            };

            var result = await userManager.CreateAsync(admin, "Admin@123456789");
            if (result.Succeeded)
            {
